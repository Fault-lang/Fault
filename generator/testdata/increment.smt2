...
(assert (ite (= increment_f_value_0 0.0) (and (= block3true_1 true) (= block4false_1 false) (= increment_f_value_3 increment_f_value_1)) (and (= block3true_1 false) (= block4false_1 true) (= increment_f_value_3 increment_f_value_2))))
...
(assert (ite (= increment_f_value_6 0.0) (and (= block3true_3 true) (= block4false_3 false) (= increment_f_value_9 increment_f_value_7)) (and (= block3true_3 false) (= block4false_3 true) (= increment_f_value_9 increment_f_value_8))))
...
(assert (ite (= increment_f_value_9 0.0) (and (= block3true_4 true) (= block4false_4 false) (= increment_f_value_12 increment_f_value_10)) (and (= block3true_4 false) (= block4false_4 true) (= increment_f_value_12 increment_f_value_11))))
...
(assert (ite (= increment_f_value_12 0.0) (and (= block3true_5 true) (= block4false_5 false) (= increment_f_value_15 increment_f_value_13)) (and (= block3true_5 false) (= block4false_5 true) (= increment_f_value_15 increment_f_value_14))))
