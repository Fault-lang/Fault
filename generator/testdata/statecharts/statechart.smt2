...
(assert (ite (and (= statechart_drain_open_4 true) (< statechart_fl_vault_value_6 0.0)) (= statechart_drain_close_4 statechart_drain_close_3) (= statechart_drain_close_4 statechart_drain_close_2)))