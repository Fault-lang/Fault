...
(declare-fun block7true_1 () Bool)
(declare-fun block7false_1 () Bool)
(declare-fun statechart_drain_close_3 () Bool)
(declare-fun statechart_drain_close_4 () Bool)
(declare-fun block10true_1 () Bool)
(declare-fun block10false_1 () Bool)
...
(declare-fun statechart_drain_close_9 () Bool)
(declare-fun statechart_drain_close_10 () Bool)
(declare-fun statechart_drain_close_11 () Bool)
(declare-fun statechart_drain_close_12 () Bool)
...
(assert (ite (and (= statechart_drain_initial_1 true) (not simple_active_0)) (and (= block3true_1 true) (= block3false_1 false) (= statechart_drain_open_2 statechart_drain_open_1)) (and (= block3true_1 false) (= block3false_1 true) (= statechart_drain_open_2 statechart_drain_open_0))))
(assert (or (and block3true_1
(not block3false_1))
(and (not block3true_1)
block3false_1)))
(assert (= statechart_drain_close_1 true))
(assert (ite (and (= statechart_drain_open_2 true) (< statechart_fl_vault_value_0 0.0)) (and (= block7true_1 true) (= block7false_1 false) (= statechart_drain_close_2 statechart_drain_close_1)) (and (= block7true_1 false) (= block7false_1 true) (= statechart_drain_close_2 statechart_drain_close_0))))
(assert (or (and block7true_1
(not block7false_1))
(and (not block7true_1)
block7false_1)))
(assert (= statechart_drain_close_3 true))
(assert (ite (= statechart_drain_close_2 true) (and (= block10true_1 true) (= block10false_1 false) (= statechart_drain_close_4 statechart_drain_close_3)) (and (= block10true_1 false) (= block10false_1 true) (= statechart_drain_close_4 statechart_drain_close_2))))
(assert (or (and block10true_1
(not block10false_1))
(and (not block10true_1)
block10false_1)))
...
block16false_3)))
(assert (ite (not statechart_drain_close_4) (and (= block13true_3 true) (= block13false_3 false) (= statechart_fl_vault_value_3 statechart_fl_vault_value_2)) (and (= block13true_3 false) (= block13false_3 true) (= statechart_fl_vault_value_3 statechart_fl_vault_value_0))))
...
(assert (ite (and (= statechart_drain_open_4 true) (< statechart_fl_vault_value_3 0.0)) (and (= block7true_3 true) (= block7false_3 false) (= statechart_drain_close_6 statechart_drain_close_5)) (and (= block7true_3 false) (= block7false_3 true) (= statechart_drain_close_6 statechart_drain_close_4))))
...
(and (not block16true_3)
block16false_3)))
(assert (ite (not statechart_drain_close_8) (and (= block18true_3 true) (= block18false_3 false) (= statechart_fl_vault_value_6 statechart_fl_vault_value_5)) (and (= block18true_3 false) (= block18false_3 true) (= statechart_fl_vault_value_6 statechart_fl_vault_value_3))))
(assert (= statechart_drain_open_5 true))
(assert (ite (and (= statechart_drain_initial_1 true) (not simple_active_0)) (and (= block3true_3 true) (= block3false_3 false) (= statechart_drain_open_6 statechart_drain_open_5)) (and (= block3true_3 false) (= block3false_3 true) (= statechart_drain_open_6 statechart_drain_open_4))))
(assert (or (and block3true_3
(not block3false_3))
(and (not block3true_3)
block3false_3)))
(assert (= statechart_drain_close_9 true))
(assert (ite (and (= statechart_drain_open_6 true) (< statechart_fl_vault_value_6 0.0)) (and (= block7true_3 true) (= block7false_3 false) (= statechart_drain_close_10 statechart_drain_close_9)) (and (= block7true_3 false) (= block7false_3 true) (= statechart_drain_close_10 statechart_drain_close_8))))
(assert (or (and block7true_3
(not block7false_3))
(and (not block7true_3)
block7false_3)))
(assert (= statechart_drain_close_11 true))
(assert (ite (= statechart_drain_close_10 true) (and (= block10true_3 true) (= block10false_3 false) (= statechart_drain_close_12 statechart_drain_close_11)) (and (= block10true_3 false) (= block10false_3 true) (= statechart_drain_close_12 statechart_drain_close_10))))
(assert (or (and block10true_3
(not block10false_3))
(and (not block10true_3)
block10false_3)))
