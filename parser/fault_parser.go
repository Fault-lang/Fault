...
func faultparserParserInit() {
	...
	staticData.serializedATN = []int32{
		4, 1, 102, 882, 2, 0, 7, 0, 2, 1, 7, 1, 2, 2, 7, 2, 2, 3, 7, 3, 2, 4, 7,
		...
		136, 138, 140, 142, 144, 146, 148, 0, 19, 2, 0, 54, 54, 62, 62, 1, 0, 70,
		71, 2, 0, 31, 31, 35, 35, 2, 0, 35, 35, 39, 39, 1, 0, 22, 24, 1, 0, 25,
		26, 3, 0, 72, 72, 83, 85, 87, 92, 1, 0, 56, 59, 2, 0, 21, 21, 54, 54, 1,
		0, 45, 52, 2, 0, 72, 72, 87, 92, 1, 0, 83, 85, 1, 0, 75, 80, 4, 0, 72,
		72, 74, 74, 83, 85, 87, 87, 1, 0, 93, 95, 1, 0, 97, 98, 1, 0, 29, 30, 1,
		0, 87, 88, 1, 0, 83, 84, 955, 0, 150, 1, 0, 0, 0, 2, 171, 1, 0, 0, 0, 4,
		...
		0, 0, 0, 170, 1, 1, 0, 0, 0, 171, 172, 5, 36, 0, 0, 172, 173, 5, 54, 0,
		0, 173, 174, 3, 148, 74, 0, 174, 3, 1, 0, 0, 0, 175, 176, 5, 34, 0, 0,
		176, 177, 5, 54, 0, 0, 177, 178, 5, 55, 0, 0, 178, 179, 3, 114, 57, 0,
		...
		0, 0, 0, 188, 189, 3, 92, 46, 0, 189, 197, 5, 55, 0, 0, 190, 198, 3, 132,
		...
		54, 0, 0, 201, 202, 5, 55, 0, 0, 202, 203, 5, 38, 0, 0, 203, 215, 5, 65,
		0, 0, 204, 209, 3, 44, 22, 0, 205, 206, 5, 61, 0, 0, 206, 208, 3, 44, 22,
		0, 207, 205, 1, 0, 0, 0, 208, 211, 1, 0, 0, 0, 209, 207, 1, 0, 0, 0, 209,
		210, 1, 0, 0, 0, 210, 213, 1, 0, 0, 0, 211, 209, 1, 0, 0, 0, 212, 214,
		5, 61, 0, 0, 213, 212, 1, 0, 0, 0, 213, 214, 1, 0, 0, 0, 214, 216, 1, 0,
		0, 0, 215, 204, 1, 0, 0, 0, 215, 216, 1, 0, 0, 0, 216, 217, 1, 0, 0, 0,
		217, 218, 5, 66, 0, 0, 218, 219, 3, 148, 74, 0, 219, 9, 1, 0, 0, 0, 220,
		...
		232, 5, 54, 0, 0, 232, 233, 3, 148, 74, 0, 233, 13, 1, 0, 0, 0, 234, 244,
		5, 12, 0, 0, 235, 245, 3, 16, 8, 0, 236, 240, 5, 63, 0, 0, 237, 239, 3,
		16, 8, 0, 238, 237, 1, 0, 0, 0, 239, 242, 1, 0, 0, 0, 240, 238, 1, 0, 0,
		0, 240, 241, 1, 0, 0, 0, 241, 243, 1, 0, 0, 0, 242, 240, 1, 0, 0, 0, 243,
		245, 5, 64, 0, 0, 244, 235, 1, 0, 0, 0, 244, 236, 1, 0, 0, 0, 245, 246,
		1, 0, 0, 0, 246, 247, 3, 148, 74, 0, 247, 15, 1, 0, 0, 0, 248, 250, 7,
		0, 0, 0, 249, 248, 1, 0, 0, 0, 249, 250, 1, 0, 0, 0, 250, 251, 1, 0, 0,
		0, 251, 253, 3, 18, 9, 0, 252, 254, 5, 61, 0, 0, 253, 252, 1, 0, 0, 0,
		...
		268, 3, 148, 74, 0, 268, 279, 1, 0, 0, 0, 269, 273, 5, 63, 0, 0, 270, 272,
		3, 24, 12, 0, 271, 270, 1, 0, 0, 0, 272, 275, 1, 0, 0, 0, 273, 271, 1,
		0, 0, 0, 273, 274, 1, 0, 0, 0, 274, 276, 1, 0, 0, 0, 275, 273, 1, 0, 0,
		0, 276, 277, 5, 64, 0, 0, 277, 279, 3, 148, 74, 0, 278, 266, 1, 0, 0, 0,
		278, 269, 1, 0, 0, 0, 279, 23, 1, 0, 0, 0, 280, 283, 3, 30, 15, 0, 281,
		282, 5, 55, 0, 0, 282, 284, 3, 32, 16, 0, 283, 281, 1, 0, 0, 0, 283, 284,
		1, 0, 0, 0, 284, 25, 1, 0, 0, 0, 285, 286, 5, 54, 0, 0, 286, 287, 5, 55,
		0, 0, 287, 288, 3, 128, 64, 0, 288, 289, 3, 148, 74, 0, 289, 296, 1, 0,
		0, 0, 290, 291, 5, 54, 0, 0, 291, 292, 5, 55, 0, 0, 292, 293, 3, 28, 14,
		0, 293, 294, 3, 148, 74, 0, 294, 296, 1, 0, 0, 0, 295, 285, 1, 0, 0, 0,
		295, 290, 1, 0, 0, 0, 296, 27, 1, 0, 0, 0, 297, 298, 6, 14, -1, 0, 298,
		306, 3, 116, 58, 0, 299, 300, 5, 74, 0, 0, 300, 306, 3, 116, 58, 0, 301,
		302, 5, 63, 0, 0, 302, 303, 3, 28, 14, 0, 303, 304, 5, 64, 0, 0, 304, 306,
		1, 0, 0, 0, 305, 297, 1, 0, 0, 0, 305, 299, 1, 0, 0, 0, 305, 301, 1, 0,
		0, 0, 306, 315, 1, 0, 0, 0, 307, 308, 10, 2, 0, 0, 308, 309, 5, 73, 0,
		0, 309, 314, 3, 28, 14, 3, 310, 311, 10, 1, 0, 0, 311, 312, 5, 81, 0, 0,
		312, 314, 3, 28, 14, 2, 313, 307, 1, 0, 0, 0, 313, 310, 1, 0, 0, 0, 314,
		317, 1, 0, 0, 0, 315, 313, 1, 0, 0, 0, 315, 316, 1, 0, 0, 0, 316, 29, 1,
		0, 0, 0, 317, 315, 1, 0, 0, 0, 318, 323, 3, 116, 58, 0, 319, 320, 5, 61,
		...
		0, 0, 334, 35, 1, 0, 0, 0, 335, 340, 3, 112, 56, 0, 336, 337, 5, 61, 0,
		0, 337, 339, 3, 112, 56, 0, 338, 336, 1, 0, 0, 0, 339, 342, 1, 0, 0, 0,
		340, 338, 1, 0, 0, 0, 340, 341, 1, 0, 0, 0, 341, 37, 1, 0, 0, 0, 342, 340,
		1, 0, 0, 0, 343, 344, 5, 6, 0, 0, 344, 345, 5, 54, 0, 0, 345, 346, 5, 55,
		0, 0, 346, 347, 3, 40, 20, 0, 347, 348, 3, 148, 74, 0, 348, 39, 1, 0, 0,
		0, 349, 350, 5, 8, 0, 0, 350, 362, 5, 65, 0, 0, 351, 356, 3, 42, 21, 0,
		352, 353, 5, 61, 0, 0, 353, 355, 3, 42, 21, 0, 354, 352, 1, 0, 0, 0, 355,
		358, 1, 0, 0, 0, 356, 354, 1, 0, 0, 0, 356, 357, 1, 0, 0, 0, 357, 360,
		1, 0, 0, 0, 358, 356, 1, 0, 0, 0, 359, 361, 5, 61, 0, 0, 360, 359, 1, 0,
		0, 0, 360, 361, 1, 0, 0, 0, 361, 363, 1, 0, 0, 0, 362, 351, 1, 0, 0, 0,
		362, 363, 1, 0, 0, 0, 363, 364, 1, 0, 0, 0, 364, 382, 5, 66, 0, 0, 365,
		366, 5, 18, 0, 0, 366, 378, 5, 65, 0, 0, 367, 372, 3, 42, 21, 0, 368, 369,
		5, 61, 0, 0, 369, 371, 3, 42, 21, 0, 370, 368, 1, 0, 0, 0, 371, 374, 1,
		0, 0, 0, 372, 370, 1, 0, 0, 0, 372, 373, 1, 0, 0, 0, 373, 376, 1, 0, 0,
		0, 374, 372, 1, 0, 0, 0, 375, 377, 5, 61, 0, 0, 376, 375, 1, 0, 0, 0, 376,
		377, 1, 0, 0, 0, 377, 379, 1, 0, 0, 0, 378, 367, 1, 0, 0, 0, 378, 379,
		1, 0, 0, 0, 379, 380, 1, 0, 0, 0, 380, 382, 5, 66, 0, 0, 381, 349, 1, 0,
		0, 0, 381, 365, 1, 0, 0, 0, 382, 41, 1, 0, 0, 0, 383, 384, 5, 54, 0, 0,
		384, 385, 5, 60, 0, 0, 385, 392, 3, 132, 66, 0, 386, 392, 3, 46, 23, 0,
		387, 388, 5, 43, 0, 0, 388, 392, 5, 54, 0, 0, 389, 390, 5, 44, 0, 0, 390,
		392, 5, 54, 0, 0, 391, 383, 1, 0, 0, 0, 391, 386, 1, 0, 0, 0, 391, 387,
		1, 0, 0, 0, 391, 389, 1, 0, 0, 0, 392, 43, 1, 0, 0, 0, 393, 394, 5, 54,
		0, 0, 394, 395, 5, 60, 0, 0, 395, 401, 3, 134, 67, 0, 396, 397, 5, 54,
		0, 0, 397, 398, 5, 60, 0, 0, 398, 401, 3, 136, 68, 0, 399, 401, 3, 46,
		23, 0, 400, 393, 1, 0, 0, 0, 400, 396, 1, 0, 0, 0, 400, 399, 1, 0, 0, 0,
		401, 45, 1, 0, 0, 0, 402, 403, 5, 54, 0, 0, 403, 404, 5, 60, 0, 0, 404,
		422, 3, 120, 60, 0, 405, 406, 5, 54, 0, 0, 406, 407, 5, 60, 0, 0, 407,
		422, 3, 128, 64, 0, 408, 409, 5, 54, 0, 0, 409, 410, 5, 60, 0, 0, 410,
		422, 3, 130, 65, 0, 411, 412, 5, 54, 0, 0, 412, 413, 5, 60, 0, 0, 413,
		422, 3, 116, 58, 0, 414, 415, 5, 54, 0, 0, 415, 416, 5, 60, 0, 0, 416,
		422, 3, 118, 59, 0, 417, 418, 5, 54, 0, 0, 418, 419, 5, 60, 0, 0, 419,
		422, 3, 108, 54, 0, 420, 422, 5, 54, 0, 0, 421, 402, 1, 0, 0, 0, 421, 405,
		...
		426, 49, 1, 0, 0, 0, 427, 429, 5, 65, 0, 0, 428, 430, 3, 52, 26, 0, 429,
		428, 1, 0, 0, 0, 429, 430, 1, 0, 0, 0, 430, 431, 1, 0, 0, 0, 431, 432,
		5, 66, 0, 0, 432, 51, 1, 0, 0, 0, 433, 435, 3, 54, 27, 0, 434, 433, 1,
		...
		10, 2, 0, 0, 462, 463, 5, 81, 0, 0, 463, 465, 3, 64, 32, 0, 464, 461, 1,
		...
		5, 73, 0, 0, 474, 476, 3, 66, 33, 0, 475, 472, 1, 0, 0, 0, 476, 479, 1,
		0, 0, 0, 477, 475, 1, 0, 0, 0, 477, 478, 1, 0, 0, 0, 478, 65, 1, 0, 0,
		0, 479, 477, 1, 0, 0, 0, 480, 486, 3, 68, 34, 0, 481, 482, 5, 63, 0, 0,
		482, 483, 3, 62, 31, 0, 483, 484, 5, 64, 0, 0, 484, 486, 1, 0, 0, 0, 485,
		480, 1, 0, 0, 0, 485, 481, 1, 0, 0, 0, 486, 67, 1, 0, 0, 0, 487, 488, 7,
		2, 0, 0, 488, 489, 5, 63, 0, 0, 489, 490, 3, 92, 46, 0, 490, 491, 5, 64,
		0, 0, 491, 496, 1, 0, 0, 0, 492, 493, 7, 3, 0, 0, 493, 494, 5, 63, 0, 0,
		494, 496, 5, 64, 0, 0, 495, 487, 1, 0, 0, 0, 495, 492, 1, 0, 0, 0, 496,
		69, 1, 0, 0, 0, 497, 502, 3, 116, 58, 0, 498, 499, 5, 67, 0, 0, 499, 500,
		3, 112, 56, 0, 500, 501, 5, 68, 0, 0, 501, 503, 1, 0, 0, 0, 502, 498, 1,
		...
		57, 0, 527, 528, 5, 55, 0, 0, 528, 529, 3, 112, 56, 0, 529, 537, 1, 0,
		...
		5, 55, 0, 0, 543, 544, 3, 36, 18, 0, 544, 550, 1, 0, 0, 0, 545, 546, 3,
		36, 18, 0, 546, 547, 7, 7, 0, 0, 547, 548, 3, 36, 18, 0, 548, 550, 1, 0,
		0, 0, 549, 538, 1, 0, 0, 0, 549, 545, 1, 0, 0, 0, 550, 81, 1, 0, 0, 0,
		551, 552, 5, 69, 0, 0, 552, 83, 1, 0, 0, 0, 553, 557, 5, 11, 0, 0, 554,
		555, 3, 56, 28, 0, 555, 556, 5, 69, 0, 0, 556, 558, 1, 0, 0, 0, 557, 554,
		...
		5, 69, 0, 0, 571, 573, 1, 0, 0, 0, 572, 569, 1, 0, 0, 0, 572, 573, 1, 0,
		...
		11, 0, 0, 584, 585, 3, 56, 28, 0, 585, 586, 5, 69, 0, 0, 586, 588, 1, 0,
		...
		608, 7, 8, 0, 0, 608, 609, 5, 62, 0, 0, 609, 614, 5, 54, 0, 0, 610, 611,
		5, 62, 0, 0, 611, 613, 5, 54, 0, 0, 612, 610, 1, 0, 0, 0, 613, 616, 1,
		0, 0, 0, 614, 612, 1, 0, 0, 0, 614, 615, 1, 0, 0, 0, 615, 93, 1, 0, 0,
		0, 616, 614, 1, 0, 0, 0, 617, 621, 5, 65, 0, 0, 618, 620, 3, 96, 48, 0,
		619, 618, 1, 0, 0, 0, 620, 623, 1, 0, 0, 0, 621, 619, 1, 0, 0, 0, 621,
		622, 1, 0, 0, 0, 622, 624, 1, 0, 0, 0, 623, 621, 1, 0, 0, 0, 624, 625,
		5, 66, 0, 0, 625, 95, 1, 0, 0, 0, 626, 629, 3, 92, 46, 0, 627, 628, 5,
		82, 0, 0, 628, 630, 3, 92, 46, 0, 629, 627, 1, 0, 0, 0, 629, 630, 1, 0,
		...
		0, 0, 645, 649, 5, 65, 0, 0, 646, 648, 3, 104, 52, 0, 647, 646, 1, 0, 0,
		0, 648, 651, 1, 0, 0, 0, 649, 647, 1, 0, 0, 0, 649, 650, 1, 0, 0, 0, 650,
		652, 1, 0, 0, 0, 651, 649, 1, 0, 0, 0, 652, 653, 5, 66, 0, 0, 653, 99,
		1, 0, 0, 0, 654, 658, 5, 65, 0, 0, 655, 657, 3, 102, 51, 0, 656, 655, 1,
		0, 0, 0, 657, 660, 1, 0, 0, 0, 658, 656, 1, 0, 0, 0, 658, 659, 1, 0, 0,
		0, 659, 661, 1, 0, 0, 0, 660, 658, 1, 0, 0, 0, 661, 662, 5, 66, 0, 0, 662,
		101, 1, 0, 0, 0, 663, 664, 5, 54, 0, 0, 664, 665, 5, 55, 0, 0, 665, 668,
		5, 14, 0, 0, 666, 669, 3, 92, 46, 0, 667, 669, 5, 54, 0, 0, 668, 666, 1,
		...
		3, 92, 46, 0, 680, 681, 5, 82, 0, 0, 681, 683, 3, 92, 46, 0, 682, 680,
		1, 0, 0, 0, 683, 686, 1, 0, 0, 0, 684, 682, 1, 0, 0, 0, 684, 685, 1, 0,
		0, 0, 685, 687, 1, 0, 0, 0, 686, 684, 1, 0, 0, 0, 687, 688, 3, 148, 74,
		0, 688, 705, 1, 0, 0, 0, 689, 694, 5, 54, 0, 0, 690, 691, 5, 82, 0, 0,
		691, 693, 5, 54, 0, 0, 692, 690, 1, 0, 0, 0, 693, 696, 1, 0, 0, 0, 694,
		...
		5, 53, 0, 0, 703, 705, 3, 148, 74, 0, 704, 679, 1, 0, 0, 0, 704, 689, 1,
		0, 0, 0, 704, 698, 1, 0, 0, 0, 704, 701, 1, 0, 0, 0, 704, 702, 1, 0, 0,
		0, 705, 105, 1, 0, 0, 0, 706, 707, 7, 9, 0, 0, 707, 107, 1, 0, 0, 0, 708,
		709, 3, 106, 53, 0, 709, 711, 5, 63, 0, 0, 710, 712, 3, 114, 57, 0, 711,
		710, 1, 0, 0, 0, 711, 712, 1, 0, 0, 0, 712, 717, 1, 0, 0, 0, 713, 714,
		5, 61, 0, 0, 714, 716, 3, 114, 57, 0, 715, 713, 1, 0, 0, 0, 716, 719, 1,
		0, 0, 0, 717, 715, 1, 0, 0, 0, 717, 718, 1, 0, 0, 0, 718, 720, 1, 0, 0,
		0, 719, 717, 1, 0, 0, 0, 720, 721, 5, 64, 0, 0, 721, 109, 1, 0, 0, 0, 722,
		...
		0, 0, 732, 733, 10, 6, 0, 0, 733, 734, 5, 86, 0, 0, 734, 751, 3, 112, 56,
		...
		4, 744, 745, 10, 2, 0, 0, 745, 746, 5, 73, 0, 0, 746, 751, 3, 112, 56,
		3, 747, 748, 10, 1, 0, 0, 748, 749, 5, 81, 0, 0, 749, 751, 3, 112, 56,
		...
		58, 0, 760, 766, 3, 70, 35, 0, 761, 762, 5, 63, 0, 0, 762, 763, 3, 112,
		56, 0, 763, 764, 5, 64, 0, 0, 764, 766, 1, 0, 0, 0, 765, 755, 1, 0, 0,
		0, 765, 756, 1, 0, 0, 0, 765, 757, 1, 0, 0, 0, 765, 758, 1, 0, 0, 0, 765,
		759, 1, 0, 0, 0, 765, 760, 1, 0, 0, 0, 765, 761, 1, 0, 0, 0, 766, 115,
		1, 0, 0, 0, 767, 778, 5, 54, 0, 0, 768, 778, 3, 92, 46, 0, 769, 778, 5,
		21, 0, 0, 770, 778, 5, 4, 0, 0, 771, 772, 5, 14, 0, 0, 772, 775, 5, 54,
		0, 0, 773, 774, 5, 62, 0, 0, 774, 776, 5, 54, 0, 0, 775, 773, 1, 0, 0,
		...
		123, 1, 0, 0, 0, 789, 790, 5, 84, 0, 0, 790, 794, 3, 122, 61, 0, 791, 792,
		5, 84, 0, 0, 792, 794, 3, 126, 63, 0, 793, 789, 1, 0, 0, 0, 793, 791, 1,
		0, 0, 0, 794, 125, 1, 0, 0, 0, 795, 796, 5, 96, 0, 0, 796, 127, 1, 0, 0,
		...
		0, 0, 0, 810, 822, 5, 65, 0, 0, 811, 816, 3, 140, 70, 0, 812, 813, 5, 61,
		0, 0, 813, 815, 3, 140, 70, 0, 814, 812, 1, 0, 0, 0, 815, 818, 1, 0, 0,
		0, 816, 814, 1, 0, 0, 0, 816, 817, 1, 0, 0, 0, 817, 820, 1, 0, 0, 0, 818,
		816, 1, 0, 0, 0, 819, 821, 5, 61, 0, 0, 820, 819, 1, 0, 0, 0, 820, 821,
		1, 0, 0, 0, 821, 823, 1, 0, 0, 0, 822, 811, 1, 0, 0, 0, 822, 823, 1, 0,
		0, 0, 823, 824, 1, 0, 0, 0, 824, 825, 5, 66, 0, 0, 825, 139, 1, 0, 0, 0,
		...
		141, 1, 0, 0, 0, 834, 835, 6, 71, -1, 0, 835, 836, 5, 74, 0, 0, 836, 843,
		3, 142, 71, 3, 837, 838, 5, 63, 0, 0, 838, 839, 3, 142, 71, 0, 839, 840,
		5, 64, 0, 0, 840, 843, 1, 0, 0, 0, 841, 843, 3, 92, 46, 0, 842, 834, 1,
		0, 0, 0, 842, 837, 1, 0, 0, 0, 842, 841, 1, 0, 0, 0, 843, 852, 1, 0, 0,
		0, 844, 845, 10, 5, 0, 0, 845, 846, 5, 73, 0, 0, 846, 851, 3, 142, 71,
		6, 847, 848, 10, 4, 0, 0, 848, 849, 5, 81, 0, 0, 849, 851, 3, 142, 71,
		5, 850, 844, 1, 0, 0, 0, 850, 847, 1, 0, 0, 0, 851, 854, 1, 0, 0, 0, 852,
		850, 1, 0, 0, 0, 852, 853, 1, 0, 0, 0, 853, 143, 1, 0, 0, 0, 854, 852,
		1, 0, 0, 0, 855, 856, 3, 92, 46, 0, 856, 857, 5, 55, 0, 0, 857, 858, 3,
		146, 73, 0, 858, 145, 1, 0, 0, 0, 859, 860, 6, 73, -1, 0, 860, 861, 5,
		63, 0, 0, 861, 862, 3, 146, 73, 0, 862, 863, 5, 64, 0, 0, 863, 867, 1,
		...
		1, 0, 0, 0, 879, 880, 5, 69, 0, 0, 880, 149, 1, 0, 0, 0, 95, 154, 163,
...
const (
	...
	FaultParserSYNTH                  = 53
	FaultParserIDENT                  = 54
	FaultParserASSIGN                 = 55
	FaultParserASSIGN_FLOW1           = 56
	FaultParserASSIGN_FLOW2           = 57
	FaultParserPLUS_ASSIGN            = 58
	FaultParserMINUS_ASSIGN           = 59
	FaultParserCOLON                  = 60
	FaultParserCOMMA                  = 61
	FaultParserDOT                    = 62
...
func (p *FaultParser) SysSpec() (localctx ISysSpecContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&18014419984318508) != 0 {
		p.SetState(163)
		p.GetErrorHandler().Sync(p)
		if p.HasError() {
			goto errorExit
...
func (p *FaultParser) Spec() (localctx ISpecContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&18014398509486188) != 0 {
		{
			p.SetState(221)
			p.Declaration()
		}
...
func (p *FaultParser) ImportDecl() (localctx IImportDeclContext) {
	...
	case FaultParserLPAREN:
		...
		for (int64((_la-54)) & ^0x3f) == 0 && ((int64(1)<<(_la-54))&26388279066881) != 0 {
			{
				p.SetState(237)
				p.ImportSpec()
			}
...
func (p *FaultParser) ConstDecl() (localctx IConstDeclContext) {
	...
	case FaultParserLPAREN:
		...
		for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&18014398511595536) != 0 {
			{
				p.SetState(270)
				p.ConstSpec()
			}
...
func (p *FaultParser) Constants() (localctx IConstantsContext) {
	...
	case FaultParserTY_STRING, FaultParserTY_BOOL, FaultParserTY_INT, FaultParserTY_FLOAT, FaultParserTY_NATURAL, FaultParserTY_UNCERTAIN, FaultParserTY_UNKNOWN, FaultParserTY_WHOLE:
		p.EnterOuterAlt(localctx, 4)
		{
			p.SetState(329)
			p.Solvable()
...
func (p *FaultParser) StructType() (localctx IStructTypeContext) {
	...
	case FaultParserFLOW:
		...
		if (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&18040786788548608) != 0 {
			{
				p.SetState(351)
				p.SfProperties()
			}
...
func (p *FaultParser) Block() (localctx IBlockContext) {
	...
	if ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&-9196385621581469648) != 0) || ((int64((_la-65)) & ^0x3f) == 0 && ((int64(1)<<(_la-65))&16917463697) != 0) {
		{
			p.SetState(428)
			p.StatementList()
		}
...
func (p *FaultParser) StatementList() (localctx IStatementListContext) {
	...
	for ok := true; ok; ok = ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&-9196385621581469648) != 0) || ((int64((_la-65)) & ^0x3f) == 0 && ((int64(1)<<(_la-65))&16917463697) != 0) {
		{
			p.SetState(433)
			p.Statement()
		}
...
func (p *FaultParser) Statement() (localctx IStatementContext) {
	...
	case FaultParserCLOCK, FaultParserNEW, FaultParserTHIS, FaultParserNIL, FaultParserTRUE, FaultParserFALSE, FaultParserTY_STRING, FaultParserTY_BOOL, FaultParserTY_INT, FaultParserTY_FLOAT, FaultParserTY_NATURAL, FaultParserTY_UNCERTAIN, FaultParserTY_UNKNOWN, FaultParserTY_WHOLE, FaultParserIDENT, FaultParserLPAREN, FaultParserSEMI, FaultParserAMPERSAND, FaultParserBANG, FaultParserPLUS, FaultParserMINUS, FaultParserCARET, FaultParserMULTI, FaultParserDECIMAL_LIT, FaultParserOCTAL_LIT, FaultParserHEX_LIT, FaultParserFLOAT_LIT, FaultParserRAW_STRING_LIT, FaultParserINTERPRETED_STRING_LIT:
		p.EnterOuterAlt(localctx, 3)
		{
			p.SetState(440)
			p.SimpleStmt()
...
func (p *FaultParser) StateBlock() (localctx IStateBlockContext) {
	...
	for (int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&-9205357043490224128) != 0 {
		{
			p.SetState(618)
			p.StateStep()
		}
...
func (p *FaultParser) RunBlock() (localctx IRunBlockContext) {
	...
	for ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&-9187378422326736880) != 0) || ((int64((_la-69)) & ^0x3f) == 0 && ((int64(1)<<(_la-69))&1057341481) != 0) {
		{
			p.SetState(646)
			p.RunStep()
		}
...
func (p *FaultParser) Solvable() (localctx ISolvableContext) {
	...
	if ((int64(_la) & ^0x3f) == 0 && ((int64(1)<<_la)&-9205357636464132080) != 0) || ((int64((_la-84)) & ^0x3f) == 0 && ((int64(1)<<(_la-84))&32257) != 0) {
		{
			p.SetState(710)
			p.Operand()
		}
