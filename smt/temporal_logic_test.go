...
func TestTemporalSys(t *testing.T) {
	...
	(assert (or (and (= test1_a_zoo_1 true) (or (= test1_b_bar_1 true) (= test1_b_bar_1 true) (= test1_b_bar_2 true))) (and (= test1_a_zoo_1 true) (or (= test1_b_bar_1 true) (= test1_b_bar_1 true) (= test1_b_bar_2 true) (= test1_b_bar_1 true) (= test1_b_bar_2 true))) (and (= test1_a_zoo_2 true) (or (= test1_b_bar_1 true) (= test1_b_bar_1 true) (= test1_b_bar_2 true) (= test1_b_bar_1 true) (= test1_b_bar_2 true))) (and (= test1_a_zoo_3 true) (or (= test1_b_bar_1 true) (= test1_b_bar_1 true) (= test1_b_bar_2 true) (= test1_b_bar_1 true) (= test1_b_bar_2 true)))))`
