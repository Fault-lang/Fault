...
(declare-fun bathtub_drawn_water_level_15 () Real)(assert (= bathtub_drawn_water_level_0 5.0))
(assert (= bathtub_drawn_water_level_1 (+ bathtub_drawn_water_level_0 10.0)))
(assert (= bathtub_drawn_water_level_2 (- bathtub_drawn_water_level_1 20.0)))
(assert (= bathtub_drawn_water_level_3 (- bathtub_drawn_water_level_0 20.0)))
...
(assert (= bathtub_drawn_water_level_6 (+ bathtub_drawn_water_level_5 10.0)))
(assert (= bathtub_drawn_water_level_7 (- bathtub_drawn_water_level_6 20.0)))
(assert (= bathtub_drawn_water_level_8 (- bathtub_drawn_water_level_5 20.0)))
...
(assert (= bathtub_drawn_water_level_11 (+ bathtub_drawn_water_level_10 10.0)))
(assert (= bathtub_drawn_water_level_12 (- bathtub_drawn_water_level_11 20.0)))
(assert (= bathtub_drawn_water_level_13 (- bathtub_drawn_water_level_10 20.0)))
(assert (= bathtub_drawn_water_level_14 (+ bathtub_drawn_water_level_13 10.0)))
